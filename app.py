...
# ===== QR CODE TRONG SIDEBAR =====
st.sidebar.markdown("---")
st.sidebar.markdown("### 📱 QUÉT MÃ QR")
st.sidebar.markdown("*Dùng camera điện thoại quét mã bên dưới*")

# Link web của bạn
web_link = "https://hva-advisor-cucphan2210.streamlit.app/"

# Tạo QR code và căn giữa 
qr_url = f"https://api.qrserver.com/v1/create-qr-code/?size=100x100&data={web_link}"

# Dùng 3 cột để căn giữa
col1, col2, col3 = st.sidebar.columns([1, 2, 1])
with col2:
    st.image(qr_url, width=100)

st.sidebar.caption(f"🔗 {web_link}")
st.sidebar.markdown("---")
